...
class GPSList {
  ...
  static datatype() {
    ...
    return 'sigsent/GPSList';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'e0b6ef8f3de100059e28b6377b1938ca';
  }

  static messageDefinition() {
    // Returns full string definition for message
    return `
    sensor_msgs/NavSatFix[] goals
    ================================================================================
