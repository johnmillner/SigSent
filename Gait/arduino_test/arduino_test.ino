...
char mode_change_header = 0b00110000;
char walking_move_header = 0b00001100;
char esc_header = 0b00000011;
char fwd = 0b00000000;
char left = 0b00001111;
char right = 0b11110000;
char back = 0b11111111;
char driving_mode = 0b00001111;
char walking_mode = 0b11110000;

// Lets the MCU to know what to expect for the next message to parse
// it correctly
char receiving_header = 1;
char receiving_mode = 0;
char receiving_walking_move = 0;
char receiving_esc_direction = 0;
char receiving_esc_speed = 0;
...
MessageType get_message_type(char header)
{
